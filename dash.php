                            ...
                            <div class="report">
                                ...
                                <div class="report-flex">
                                    ...
                                    <div class="report-box2">
                                        <canvas id="piechart" width="100%" height="81"></canvas>
                                    </div>
                                    <div class="report-box3">
                                        <canvas id="radarchart" width="100%" height="81"></canvas>
                                    </div>
                                </div>
                            </div>

                            <div class="dttable">
                                <table id="dttable" class="display" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Position</th>
                    ...
                    datasets: [
                        {
                            label: "A",
                            data: [28, 24, 7],
                            backgroundColor: ["#ff6358", "#ffd246", "#28b4c8"],
                        },
                    ],
                },
            });
